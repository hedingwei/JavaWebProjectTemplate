...
function showBox() {
    ...
    cont += "                                        <label for='Dev_Name' class='col-sm-3 control-label no-padding-right' style='float: left;text-align: right;width: 25%;'>设备名称</label>";
    ...
    cont += "                                    </div>";
    cont += "                                    <div class='form-group'>";
    cont += "                                        <label for='IP' class='col-sm-3 control-label no-padding-right' style='float: left;text-align: right;width: 25%;'>设备IP地址</label>";
    cont += "                                        <div class='col-sm-9' style='float: left;text-align: right;width: 75%;'>";
    ...
    cont += "                                        <label for='DeploySiteName' class='col-sm-3 control-label no-padding-right' style='float: left;text-align: right;width: 25%;'>设备部署站点名称</label>";
    cont += "                                        <div class='col-sm-9' style='float: left;text-align: right;width: 75%;'>";
    cont += "                                            <input type='text' class='col-xs-8' name='3' id='DeploySiteName' required>";
    cont += "                                        </div>";
    cont += "                                    </div>";
    cont += "                                    <div class='form-group'>";
    cont += "                                        <label for='Desc' class='col-sm-3 control-label no-padding-right' style='float: left;text-align: right;width: 25%;'>设备描述</label>";
    cont += "                                        <div class='col-sm-9' style='float: left;text-align: right;width: 75%;'>";
...
function updataDevice(id) {
    ...
    $.ajax({
        ...
        async: false,
        url: "../device/edit",
        data: {id: id, result: JSON.stringify(policyDepot), description: Desc, Dev_Name: Dev_Name, Dev_IP: IP, Probe_Type: Probe_Type, DeploySiteName: DeploySiteName, IDC_HouseID: DeploySiteName},
        dataType: "json",
        success: function (data) {
            //obj = data;
            if (data.result == "true") {
...
function saveDevice() {
    ...
    $.ajax({
        ...
        async: false,
        url: "../device/create",
        data: {result: JSON.stringify(policyDepot), description: Desc, Dev_Name: Dev_Name, Dev_IP: IP, Probe_Type: Probe_Type, DeploySiteName: DeploySiteName, IDC_HouseID: DeploySiteName},
        dataType: "json",
        success: function (data) {
            //obj = data;
            if (data.result == "true") {
