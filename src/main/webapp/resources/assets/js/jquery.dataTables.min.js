    ...
    var L = function (h) {
        var j = function (e) {
                ...
                if (!1 !==
                    ...
                    for (f = 0; f < d.length; f++) {
                        ...
                        for (g = 0; g < i.length; g++)
                            c.push({name: "iSortCol_" + e, value: i[g]}), c.push({
                                name: "sSortDir_" + e,
                                value: d[f][1]
                            }), e++
                    }
            ...
            function pa(a) {
                ...
                !a.sEmptyTable && (a.sZeroRecords && "未查询到数据" === b.sEmptyTable) && p(a, a, "sZeroRecords", "sEmptyTable");
                !a.sLoadingRecords &&
            ...
            function qa(a, b) {
                ...
                if ("number" === typeof b)
                    ...
                    D(a, 0, "Unknown paging controller: " + b);
        ...
        j.defaults = {
            ...
            oLanguage: {
                ...
                sEmptyTable: "未查询到数据",
                sInfo: "当前显示第 _START_ 到 _END_ 条记录，总共 _TOTAL_ 条记录",
                sInfoEmpty: "当前显示第 0 到 0 条记录，总共 0 条记录",
