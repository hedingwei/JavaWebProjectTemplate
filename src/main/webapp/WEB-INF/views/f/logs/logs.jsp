...
<div class="main-container">
	<div class="tabbable">
		<form:form id="form" action="${pageContext.request.contextPath}/f/logs/list.view.do" method="get">
		<div class="">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<%--<table id="basicTable_model" class="table table-primary table-bordered table-striped table-hover table-condensed">--%>
										<%--<tr>--%>
											<%--<td></td>--%>
										<%--</tr>--%>
										<%--<tr>--%>
